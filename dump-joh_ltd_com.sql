...
INSERT INTO `attr_def_groups` VALUES ('user','会員情報属性','会員情報として保持する属性',0,'*',0,'*','*',0);
...
INSERT INTO `attr_defs` VALUES ('user','company_name','会社名',1,NULL,'',1,NULL,256,'',NULL,NULL,NULL,NULL,-9.9,9.9,0.1,NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,'','',30,4,6,1,0,'*',0,'*','*',0),('user','company_name_kana','会社名（フリガナ）',1,NULL,'',1,NULL,256,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,'','',30,NULL,7,1,0,'*',0,'*','*',0),('user','employee_cout','従業員数',1,NULL,'*',6,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'employee_cout',1,NULL,NULL,NULL,'','',NULL,NULL,8,1,0,'*',0,'*','*',0),('user','full_name','お名前',1,NULL,'',1,NULL,64,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,'','',15,NULL,1,1,0,'*',0,'*','*',0),('user','full_name_kana','フリガナ',1,NULL,'',1,NULL,64,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,'','',15,NULL,2,1,0,'*',0,'*','*',0),('user','industry','業種',1,NULL,'*',6,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'industries',1,NULL,NULL,NULL,'','',NULL,5,9,1,0,'*',0,'*','*',0),('user','prefecture','都道府県',1,NULL,'*',6,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'prefectures',1,NULL,NULL,NULL,'','',NULL,NULL,4,1,0,'*',0,'*','*',0),('user','purpose_use','ご利用の目的',1,NULL,NULL,6,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'purpose_use',2,NULL,NULL,NULL,'','',NULL,NULL,5,1,0,'*',0,'*','*',0),('user','qa_how_know','GoodLifeを知ったきっかけ',1,NULL,'',6,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'how_know_answer',3,NULL,NULL,NULL,'','',40,NULL,11,1,0,'*',0,'*','*',0),('user','qa_post_is_first','ポスト投稿は初めてですか？',1,NULL,'yes',6,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'post_is_first_answer',1,NULL,NULL,NULL,'','',NULL,NULL,10,1,0,'*',0,'*','*',0),('user','tel_no','電話番号',1,'tel','',1,NULL,14,'^[0-9]+[\\-]?[0-9]+[\\-]?[0-9]+$',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,'','',12,NULL,3,1,0,'*',0,'*','*',0);
...
INSERT INTO `divisions` VALUES ('employee_cout','従業員人数',1,3,0,'*',0,'*','*',0),('how_know_answer','GoodLifeを知ったきっかけ',1,6,0,'*',0,'*','*',0),('industries','業種',1,4,0,'*',0,'*','*',0),('post_is_first_answer','ポスト投稿は初めてですか？',1,5,0,'*',0,'*','*',0),('prefectures','都道府県',1,1,0,'*',0,'*','*',0),('purpose_use','利用目的',1,2,0,'*',0,'*','*',0);
...
INSERT INTO `screens` VALUES ('attest','/scene/attest','ログイン',0,'*',0,'*','*',0),('new_user','/scene/new_user','新規会員登録（無料）',0,'*',0,'*','*',0),('service_terms','/','利用規約',0,'*',0,'*','*',0),('top','/scene/top','トップ',0,'*',0,'*','*',0),('user_regist','/scene/user_regist','会員登録',0,'*',0,'*','*',0);
