...
<div id="{!! $id !!}" class="JOH-W-Full JOH-Color-Panel-Footer" style="position:relative;">
  ...
  <div class="JOH-W-Full JOH-Flex Columns-CC">
    <dl class="JOH-Horizontal">
      ...
      <dd class="JOH-PH-MEM">
        @links(['id'=>'pnl' . str_replace('_', '', ucwords($link_group_rel->link_group_id, '_')) . '_' . str_replace('_', '', ucwords($link_group_rel->link_id, '_')), 'link_id'=>$link_group_rel->link_id, 'certified'=>!$is_guest, 'class'=>[ 'dl'=>'JOH-Virtical', 'dl/dt'=>'JOH-Font-SS', 'dl/dd'=>'JOH-None' ], 'style'=>[ 'dl/dt'=>'margin-top:0.25em;margin-bottom:0.25em;' ] ])
        @endlinks
      </dd>
      @endforeach
    </dl>
