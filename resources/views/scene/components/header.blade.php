...
<nav class="JOH-Flex Columns-TBetween JOH-W-Full JOH-LineH-S JOH-Color-Panel-MenuBar" style="padding:0.2em 4em;">
  <div class="JOH-Flex Columns-TBetween">
    ...
    @if (!$is_guest)
      @links([ 'id'=>'pnlHeaderMenuLeft', 'link_id'=>'header_left', 'certified'=>!$is_guest, 'class'=>['dl'=>'JOH-Horizontal Separated JOH-IPos-Left', 'dl/dt'=>'JOH-Color-Label-MenuItem JOH-PH-SSEM', 'dl/dd'=>'JOH-None', 'dl/dt/a'=>'JOH-Font-S JOH-LineH-S'], 'style'=>[ 'dl'=>'border-left: 1px solid #cccccc;' ] ])
      @endlinks
    @endif
  </div>
