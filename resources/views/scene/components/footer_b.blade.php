...
<div id="{!! $id !!}" class="JOH-W-Full JOH-Color-Panel-Footer" style="position:relative;">
  ...
  <div class="JOH-W-Full JOH-Flex Rows-TC JOH-P-SSEM" style="flex-wrap:wrap;height:840px;">
    ...
    <div class="JOH-PH-MEM" style="margin-bottom:2em;">
      ...
      @links(['id'=>'pnl' . str_replace('_', '', ucwords($link_group_rel->link_group_id, '_')) . '_' . str_replace('_', '', ucwords($link_group_rel->link_id, '_')), 'link_id'=>$link_group_rel->link_id, 'certified'=>!$is_guest, 'class'=>[ 'dl'=>'JOH-Virtical', 'dl/dt'=>'JOH-Font-SS', 'dl/dd'=>'JOH-None' ] ])
      @endlinks
    </div>
    @endforeach
  </div>
